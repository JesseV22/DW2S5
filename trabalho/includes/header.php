...
<head>
    ...
    <style>
        ...
        body::before {
            ...
            width: 100%;
            height: 100%;
            background-image: url('https://www.modalmais.com.br/wp-content/uploads/2021/04/iStock-801479766-3.jpg');
            /* URL da sua imagem de fundo */
            background-size: cover;
            /* Ajusta o tamanho da imagem para cobrir todo o corpo */
            filter: blur(5px);
            /* Ajuste o valor do raio do desfoque conforme necessário */
            z-index: -1;
            /* Coloca o fundo desfocado atrás do conteúdo */
        }
